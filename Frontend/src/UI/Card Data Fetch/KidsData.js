...
export default function KidsData() {
    ...
    const KidsData = useSelector((state) => state.kids_category.kidscategories);
    const loading = useSelector((state) => state.kids_category.loading);
    const error = useSelector((state) => state.kids_category.error);
    ...
    const filteredCategories = KidsData.filter(product => product.category === category);
